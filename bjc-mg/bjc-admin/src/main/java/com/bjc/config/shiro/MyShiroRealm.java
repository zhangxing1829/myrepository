package com.bjc.config.shiro;

import com.baomidou.mybatisplus.mapper.EntityWrapper;
import com.bjc.common.utils.StringUtil;
import com.bjc.entity.Permission;
import com.bjc.entity.User;
import com.bjc.mapper.PermissionMapper;
...
public class MyShiroRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        // 查询用户拥有那些权限
        List<Permission> permissions = permissionMapper.findUserPermission(user.getuId());
